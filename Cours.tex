...
\begin{center}
    ...
    {\color{white}\fontsize{30}{38}\selectfont\bfseries
        Hacking Éthique,}\\[0.3ex]
       {\color{white}\fontsize{28}{36}\selectfont\bfseries
        et Tests d’Intrusion}\\[1.5ex]
    {\color{CouleurAccent}\Large\itshape
        Méthodologie, Exploitation et Rapport Professionnel}
\end{center}
...
\input{chapitres/01_cas_lizbiz_scope}

% Chapitre 2 — Cadre juridique et méthodologies
\input{chapitres/02_methodo_juridique}

% Chapitre 3 — Reconnaissance passive et OSINT
\input{chapitres/03_recon_osint}

% Chapitre 4 — Scanning actif et énumération
\input{chapitres/04_scanning_enum}
...
\input{chapitres/05_exploitation}

% Chapitre 6 — Post-exploitation et mouvement latéral
\input{chapitres/06_post_exploitation}

% Chapitre 7 — Évasion des défenses et anti-forensics
\input{chapitres/07_evasion_antiforensic}
...
\input{chapitres/08_reporting}

% Chapitre 9 — Évaluation finale
\input{chapitres/09_evaluation_finale}
